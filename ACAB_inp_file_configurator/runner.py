...
class _Runner:
    ...
    def _reset_state(self) -> None:
        ...
        # cadenas: el job vive en iso_<isótopo>/ pero su paso CHAINS corre
        # en chains_<isótopo>/) -- sin esto, status() solo podía enseñar el
        # run.log del workdir de nivel job, nunca el de la carpeta donde
        # falló de verdad el paso en curso.
