# setup.ps1 - Crea el entorno virtual e instala las dependencias de ACAB-Configurator
...
# copias en ACAB_fort_file_analyzer/, COLLAPS_inp_file_configurator/ y
...
Write-Host ""
Write-Host "=== ACAB-Configurator - Configuración del entorno (Windows) ===" -ForegroundColor Cyan
